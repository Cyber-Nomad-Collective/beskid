...
## Goal
Stabilize stdlib behavior, parity, and release criteria.

## Tasks
1. Add analysis/type/codegen/runtime parity tests for stdlib APIs.
2. Validate JIT/AOT parity for stdlib-backed behavior.
...
- No backend divergence for stdlib semantics.
