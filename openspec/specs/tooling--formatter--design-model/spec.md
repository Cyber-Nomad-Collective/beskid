...
# Formatter design model Specification

## Purpose

Emit/EmitCtx/Emitter architecture, policy split, and the layout invariants the formatter exposes.

## Requirements

### Requirement: Formatter design model conformance status
...
**Stable ID:** `BSP-REQ-ED445CBA7E8C`
...
### Source Record: Formatter design model

**Authority:** informative provenance  
**Legacy path:** `/platform-spec/tooling/formatter/design-model/`  
**Source:** `site/spec-content/platform-spec/tooling/formatter/design-model/content.md`  
**SHA-256:** `81555d94d4e39c8ffe8d91d848800559b5f3f762d9cbc348c9e2e98fee2f835d`
