> **Release scope:** This pending change plans Glue delivery for v0.6.
> It creates no v0.5 acceptance requirement; v0.5 retains the existing
> fail-closed Glue backend behavior and CLIF production path.
