...
use pecan_analysis::hir::{HirMatchExpression, HirPattern};
...
fn bind_match_pattern(
    ctx: &mut NodeLoweringContext<'_, '_>,
    scrutinee: Value,
    item_id: pecan_analysis::resolve::ItemId,
    variants: &[(String, Vec<pecan_analysis::types::TypeId>)],
    arm: &Spanned<pecan_analysis::hir::HirMatchArm>,
) -> Result<(), CodegenError> {
    match &arm.node.pattern.node {
