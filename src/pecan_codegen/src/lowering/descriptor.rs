...
fn primitive_layout(primitive: pecan_analysis::hir::HirPrimitiveType) -> TypeLayout {
    let (size, align) = match primitive {
        pecan_analysis::hir::HirPrimitiveType::Bool => (1, 1),
        pecan_analysis::hir::HirPrimitiveType::I32 => (4, 4),
        pecan_analysis::hir::HirPrimitiveType::I64 => (8, 8),
        pecan_analysis::hir::HirPrimitiveType::U8 => (1, 1),
        pecan_analysis::hir::HirPrimitiveType::F64 => (8, 8),
        pecan_analysis::hir::HirPrimitiveType::Unit => (0, 1),
        pecan_analysis::hir::HirPrimitiveType::Char => (4, 4),
        pecan_analysis::hir::HirPrimitiveType::String => (8, 8),
    };
    TypeLayout {
        size,
        align,
