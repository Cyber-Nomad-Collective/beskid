...
use pecan_analysis::resolve::{ItemKind, Resolver};
use pecan_analysis::syntax::{Program, Spanned};
use pecan_analysis::types::{type_program, TypeInfo};
use pecan_analysis::{builtin_rules, AnalysisOptions, run_rules};
use pecan_analysis::analysis::diagnostics::Severity;
...
#[derive(Args, Debug)]
pub struct RunArgs {
    /// The input Pecan file to JIT-compile and execute
    #[arg(required = true)]
    pub input: PathBuf,
