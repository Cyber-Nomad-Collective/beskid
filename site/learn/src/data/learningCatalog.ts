...
export const learnExercises: ReadonlyArray<LearnExercise> = [
		...
		questions: [
			{
				id: "01_q1",
				text:
					"Which type does the Main function return in the minimal Beskid program?",
		...
		questions: [
			{
				id: "05_q1",
				text:
					"What is the result of `first + second == 3` when first=1 and second=2?",
	...
	},
	{
		...
		starterCode: ["i32 Main() {", "  return 42;", "}"].join("\n"),
		command: "parse",
		hints: [
	...
	},
	{
		...
		questions: [
			...
			},
			{
				id: "08_q3",
				text:
					"If your program has a type error, will `beskid run` still execute it?",
				options: [
					"Yes, with a warning",
