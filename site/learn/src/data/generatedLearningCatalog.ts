...
export const generatedLearnExercises = [
	{
		...
		objective:
			"Use the Beskid Learn loop to turn each compiler check into evidence about one programming rule.",
		...
		lessonPath:
			"/site/learn/curriculum/00-orientation/01-learning-loop/lesson.md",
		difficulty: "beginner",
	...
	},
	{
		...
		objective:
			"Locate the first relevant compiler diagnostic, identify its phase, and make a narrow repair.",
		...
		lessonPath:
			"/site/learn/curriculum/00-orientation/02-reading-diagnostics/lesson.md",
		difficulty: "beginner",
		category: "orientation",
	...
	},
	{
		...
		objective:
			"Make a valid entry point and explain what its result communicates.",
		...
		lessonPath:
			"/site/learn/curriculum/01-foundations/01-main-and-exit-codes/lesson.md",
		difficulty: "beginner",
		...
		questions: [
			{
				...
				options: ["The return expression", "The closing brace"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/01-foundations/02-values-literals-and-types/lesson.md",
		difficulty: "beginner",
		category: "foundations",
		...
		questions: [
			{
				...
				options: ["An integer literal bound to name", "The name of the variable"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/01-foundations/03-names-and-immutability/lesson.md",
		difficulty: "beginner",
		category: "foundations",
		...
		questions: [
			{
				...
				options: ["A declaration of score in scope", "A second return statement"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/01-foundations/04-operators-and-expressions/lesson.md",
		difficulty: "beginner",
		category: "foundations",
		...
		questions: [
			{
				...
				text:
					"What is evaluated before the equality comparison in first + second == 3?",
				options: ["The addition first + second", "The return statement"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		objective:
			"Reassign a local only when its binding explicitly permits mutation.",
		slug: "05-mutation-and-assignment",
		starterCode:
			"// Reference-only: lesson.md cites the authoritative behavior and verification boundary.",
		command: "reference",
		mode: "reference-only",
		...
		lessonPath:
			"/site/learn/curriculum/01-foundations/05-mutation-and-assignment/lesson.md",
		...
		questions: [
			{
				...
				options: ["let mut total = 0", "let total = 0"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/02-control-flow/01-functions-and-contracts/lesson.md",
		difficulty: "intermediate",
		...
		questions: [
			{
				...
				options: ["Parameters a and b", "Arguments 1 and 2"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/02-control-flow/02-choices-with-if/lesson.md",
		difficulty: "intermediate",
		category: "control-flow",
		...
		questions: [
			{
				...
				options: ["An even integer such as 4", "An odd integer such as 3"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		starterCode:
			"// Reference-only lesson: see lesson.md and source cited in front matter.",
		command: "reference",
		mode: "reference-only",
		status: "reference-only",
		hints: [
		...
		lessonPath:
			"/site/learn/curriculum/02-control-flow/03-repetition-with-loops/lesson.md",
		difficulty: "intermediate",
		category: "control-flow",
	...
	},
	{
		...
		objective:
			"Consolidate functions, choices, and repetition through prediction.",
		...
		lessonPath:
			"/site/learn/curriculum/02-control-flow/04-control-flow-retrieval/lesson.md",
		difficulty: "intermediate",
		category: "control-flow",
	...
	},
	{
		...
		objective:
			"Trace compound conditions and identify when a right-hand test is skipped.",
		...
		lessonPath:
			"/site/learn/curriculum/02-control-flow/05-boolean-logic-and-short-circuiting/lesson.md",
		difficulty: "intermediate",
		category: "control-flow",
	...
	},
	{
		...
		objective:
			"Predict whether a loop stops or skips the remaining work of one iteration.",
		...
		lessonPath:
			"/site/learn/curriculum/02-control-flow/06-break-and-continue/lesson.md",
		difficulty: "intermediate",
		category: "control-flow",
		...
		questions: [
			{
				...
				options: ["The rest of this iteration is skipped", "The whole loop ends"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/03-data-modeling/01-structs-and-fields/lesson.md",
		difficulty: "intermediate",
	...
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/03-data-modeling/02-methods-and-receivers/lesson.md",
		difficulty: "intermediate",
		category: "data-modeling",
		...
		questions: [
			{
				...
				options: ["The receiver's static type", "A guessed runtime branch"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/03-data-modeling/03-enums-for-states/lesson.md",
		difficulty: "intermediate",
		category: "data-modeling",
	...
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/03-data-modeling/04-match-and-exhaustiveness/lesson.md",
		difficulty: "intermediate",
		category: "data-modeling",
	...
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/03-data-modeling/05-arrays-and-collections/lesson.md",
		difficulty: "intermediate",
		category: "data-modeling",
	...
	},
	{
		...
		objective:
			"Describe an event trigger, owner, and subscriber responsibility without assuming delivery order.",
		...
		lessonPath:
			"/site/learn/curriculum/03-data-modeling/06-events-and-subscribers/lesson.md",
		difficulty: "intermediate",
		category: "data-modeling",
		...
		questions: [
			{
				...
				options: ["The Fiber handle", "An arbitrary spawn closure"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		objective:
			"Explain how modules and use declarations give names an unambiguous origin.",
		slug: "01-modules-and-use",
		starterCode:
			"// Reference-only lesson package. The curriculum tool requires a safe placeholder.\\ni32 Main() {\\n  return 0;\\n}\\n",
		command: "reference",
		mode: "reference-only",
		status: "reference-only",
		hints: [
		...
		lessonPath:
			"/site/learn/curriculum/04-program-structure/01-modules-and-use/lesson.md",
		difficulty: "intermediate",
	...
	},
	{
		...
		objective:
			"Distinguish a public API promise from a private implementation detail.",
		...
		lessonPath:
			"/site/learn/curriculum/04-program-structure/02-visibility-and-public-apis/lesson.md",
		difficulty: "intermediate",
		category: "program-structure",
	...
	},
	{
		...
		objective:
			"Explain how manifests, dependencies, corelib, analyze, build, and run fit together.",
		...
		lessonPath:
			"/site/learn/curriculum/04-program-structure/03-projects-packages-and-builds/lesson.md",
		difficulty: "intermediate",
		category: "program-structure",
	...
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/04-program-structure/04-tests-and-diagnostics/lesson.md",
		difficulty: "intermediate",
		category: "program-structure",
		...
		questions: [
			{
				...
				options: ["A diagnostic fixture", "A runtime output assertion"],
				correctIndex: 0,
			},
		],
	},
	{
		...
		objective:
			"Navigate corelib as a resolved dependency and distinguish public APIs from runtime internals.",
		...
		lessonPath:
			"/site/learn/curriculum/08-core-library/01-discovering-corelib-and-apis/lesson.md",
		difficulty: "intermediate",
	...
	},
	{
		...
		objective:
			"Use signatures and documentation to predict a corelib call’s inputs, output, and failure modes.",
		...
		lessonPath:
			"/site/learn/curriculum/08-core-library/02-reading-api-docs-and-signatures/lesson.md",
		difficulty: "intermediate",
		category: "core-library",
	...
	},
	{
		...
		objective:
			"Choose arrays and optional presence without hidden sentinel conventions.",
		...
		lessonPath:
			"/site/learn/curriculum/08-core-library/03-practical-collections/lesson.md",
		difficulty: "intermediate",
		category: "core-library",
	...
	},
	{
		...
		objective:
			"Treat conversions and formatting as explicit boundary operations with specified failure behavior.",
		...
		lessonPath:
			"/site/learn/curriculum/08-core-library/04-conversions-and-formatting/lesson.md",
		difficulty: "intermediate",
		category: "core-library",
	...
	},
	{
		...
		objective:
			"Model a value that may be absent without using null or a sentinel value.",
		slug: "01-option-and-absence",
		starterCode:
			"// Reference-only lesson package; see lesson.md for the normative-pending Option<T> sketch.\ni32 Main() {\n  return 0;\n}",
		command: "reference",
		mode: "reference-only",
		status: "reference-only",
		hints: [
		...
		lessonPath:
			"/site/learn/curriculum/05-reliability-and-abstraction/01-option-and-absence/lesson.md",
		difficulty: "intermediate",
	...
	},
	{
		...
		objective:
			"Model expected unsuccessful work as an explicit outcome a caller can inspect.",
		...
		lessonPath:
			"/site/learn/curriculum/05-reliability-and-abstraction/01-result-and-fallible-work/lesson.md",
		difficulty: "intermediate",
		category: "reliability-and-abstraction",
	...
	},
	{
		...
		objective:
			"Use error variants and payloads to make recovery decisions explicit.",
		...
		lessonPath:
			"/site/learn/curriculum/05-reliability-and-abstraction/02-errors-as-data/lesson.md",
		difficulty: "intermediate",
		category: "reliability-and-abstraction",
	...
	},
	{
		...
		objective:
			"Explain how type parameters make reusable code vary only where its contract allows.",
		...
		lessonPath:
			"/site/learn/curriculum/05-reliability-and-abstraction/03-generic-reusable-code/lesson.md",
		difficulty: "intermediate",
		category: "reliability-and-abstraction",
	...
	},
	{
		...
		objective:
			"Use contracts to declare the capabilities a type offers to callers.",
		...
		lessonPath:
			"/site/learn/curriculum/05-reliability-and-abstraction/04-contracts-and-conformance/lesson.md",
		difficulty: "intermediate",
		category: "reliability-and-abstraction",
	...
	},
	{
		...
		objective:
			"Recognize a lambda as a callable value whose type must be inferable or annotated.",
		slug: "01-lambdas",
		starterCode:
			"// Reference-only lesson package. The curriculum tool requires a safe placeholder.\\ni32 Main() {\\n  return 0;\\n}\\n",
		command: "reference",
		...
		lessonPath:
			"/site/learn/curriculum/06-functions-with-context/01-lambdas/lesson.md",
		difficulty: "intermediate",
	...
	},
	{
		...
		objective:
			"Explain capture, definite assignment, and lifetime boundaries for closures.",
		...
		lessonPath:
			"/site/learn/curriculum/06-functions-with-context/02-capture-and-lifetime-boundaries/lesson.md",
		difficulty: "intermediate",
		category: "functions-with-context",
	...
	},
	{
		...
		objective:
			"Choose a named function, lambda, or contract-backed collaborator based on reuse and ownership.",
		...
		lessonPath:
			"/site/learn/curriculum/06-functions-with-context/03-composing-behaviour/lesson.md",
		difficulty: "intermediate",
		category: "functions-with-context",
	...
	},
	{
		...
		objective:
			"Explain cooperative fibers without making timing or run-order promises.",
		...
		lessonPath:
			"/site/learn/curriculum/07-fibers-and-channels/01-cooperative-concurrency-model/lesson.md",
		difficulty: "intermediate",
	...
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/07-fibers-and-channels/02-spawn-and-fiber-handles/lesson.md",
		difficulty: "intermediate",
		category: "fibers-and-channels",
	...
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/07-fibers-and-channels/03-join-and-fiber-results/lesson.md",
		difficulty: "intermediate",
		category: "fibers-and-channels",
	...
	},
	{
		...
		objective:
			"Distinguish Yield, Cancel, and Detach and their responsibility boundaries.",
		...
		lessonPath:
			"/site/learn/curriculum/07-fibers-and-channels/04-yield-cancel-and-detach/lesson.md",
		difficulty: "intermediate",
		category: "fibers-and-channels",
	...
	},
	{
		...
		lessonPath:
			"/site/learn/curriculum/07-fibers-and-channels/05-channels-and-message-passing/lesson.md",
		difficulty: "intermediate",
		category: "fibers-and-channels",
	...
	},
	{
		...
		objective:
			"Design a multi-fiber quest log with channels for payloads and coordination for invariants.",
		...
		lessonPath:
			"/site/learn/curriculum/07-fibers-and-channels/06-concurrent-quest-log-capstone/lesson.md",
		difficulty: "intermediate",
		category: "fibers-and-channels",
	...
	},
	{
		...
		objective:
			"Explain extend type as an external member contribution with a clear ownership boundary.",
		...
		lessonPath:
			"/site/learn/curriculum/09-advanced-language/01-extending-types/lesson.md",
		difficulty: "intermediate",
	...
	},
	{
		...
		objective:
			"Explain attributes as declared metadata whose meaning belongs to a consuming tool or rule.",
		...
		lessonPath:
			"/site/learn/curriculum/09-advanced-language/02-attributes-and-annotations/lesson.md",
		difficulty: "intermediate",
		category: "advanced-language",
	...
	},
	{
		...
		objective:
			"Use documentation comments as attached item documentation, not ordinary narration.",
		...
		lessonPath:
			"/site/learn/curriculum/09-advanced-language/03-documentation-comments/lesson.md",
		difficulty: "intermediate",
		category: "advanced-language",
	...
	},
	{
		...
		objective:
			"Explain macro definitions and invocations as syntax-level generation with explicit expansion boundaries.",
		slug: "04-macros",
		starterCode:
			"// Reference-only lesson package. The curriculum tool requires a safe placeholder.\\ni32 Main() {\\n  return 0;\\n}\\n",
		command: "reference",
	...
	},
	{
		...
		objective:
			"Explain compiler mods as constrained tooling contributions rather than hidden source mutation.",
		...
		lessonPath:
			"/site/learn/curriculum/09-advanced-language/05-mods-and-conditional-compilation/lesson.md",
		difficulty: "intermediate",
		category: "advanced-language",
	...
	},
	{
		...
		objective:
			"Treat serialization as an explicit contract between data shape, version, and error handling.",
		...
		lessonPath:
			"/site/learn/curriculum/09-advanced-language/06-serialization/lesson.md",
		difficulty: "intermediate",
		category: "advanced-language",
	...
	},
	{
		...
		objective:
			"Explain FFI as a declared ABI boundary with explicit types, ownership, and linking rules.",
		...
		lessonPath:
			"/site/learn/curriculum/09-advanced-language/07-ffi-boundaries/lesson.md",
		difficulty: "intermediate",
		category: "advanced-language",
	...
	},
	{
		...
		objective:
			"Explain the memory/reference model and why boundaries reject unsafe escaping references.",
		...
		lessonPath:
			"/site/learn/curriculum/09-advanced-language/08-memory-and-ownership/lesson.md",
		difficulty: "intermediate",
		category: "advanced-language",
