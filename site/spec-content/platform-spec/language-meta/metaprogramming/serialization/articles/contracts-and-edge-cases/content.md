---
title: Serialization packages - Contracts and edge cases
description: Normative contracts, edge cases, hard requirements, and invariants for Serialization packages.
specLevel: article
owner:
