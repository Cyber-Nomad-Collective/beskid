---
title: Project scaffolding - Decisions record (legacy index)
description: Migration index for ADRs under project-scaffolding
  features—normative text lives in adr/ files.
specLevel: feature
owner:
