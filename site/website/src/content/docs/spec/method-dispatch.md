...
- Event declaration/subscription/invocation semantics are defined in `docs/spec/events.md`.
- Lambda and closure semantics are defined in `docs/spec/lambdas-and-closures.md`.
