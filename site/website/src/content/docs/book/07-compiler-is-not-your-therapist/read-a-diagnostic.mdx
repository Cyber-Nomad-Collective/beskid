...
```mermaid
flowchart TD
  accTitle: Reading a diagnostic
  accDescr: Read the span, minimize the repro, then use parse or tree for syntax problems and analyze for name and type problems before checking the spec.
