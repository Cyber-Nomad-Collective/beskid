...
| 10 | [Memory without another billion-dollar mistake](/book/10-memory-without-billion-dollar-mistake/) | [Memory model](/platform-spec/language-meta/memory-model/) | — | `beskid_analysis`, `beskid_engine` |
| 11 | [Fibers: cheaper than threads](/book/11-fibers-cheaper-than-threads/) | [Evaluation / fibers](/platform-spec/language-meta/evaluation/fibers-and-spawn/), [Execution / channels](/platform-spec/execution/runtime/channels-and-synchronization/) | — | `beskid_engine`, corelib concurrency |
...
| 17 | [Execution: ABI, host, and runtime](/book/17-execution-abi-host-runtime/) | [Execution](/platform-spec/execution/), [Conformance](/platform-spec/compiler/conformance/) | — | `beskid_abi`, `beskid_engine` |
...
| 21 | [FFI and forbidden friendships](/book/21-ffi-and-forbidden-friendships/) | [Interop](/platform-spec/language-meta/interop/), [Extern dispatch](/platform-spec/execution/abi-and-host/extern-dispatch-and-policy/) | — | `beskid_abi`, `beskid_engine` |
