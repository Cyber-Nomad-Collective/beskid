...
The [C ABI profile](/docs/standard/language-meta/interop/c-abi-profile/) covers link-time linking, dynamic resolution, and platform-specific notes (including what is intentionally *not* in stdlib).
...
For dispatch behavior after an import is chosen, continue with [extern dispatch and policy](/docs/standard/execution/abi-and-host/extern-dispatch-and-policy/).
