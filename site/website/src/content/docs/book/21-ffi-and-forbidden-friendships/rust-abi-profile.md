...
[Rust ABI profile](/docs/standard/language-meta/interop/rust-abi-profile/) documents the language-owned runtime's boundary stability, [runtime manifest](/docs/standard/language-meta/interop/rust-abi-profile/runtime-manifest/), and ABI-v5 [kernel and dispatch](/docs/standard/language-meta/interop/rust-abi-profile/kernel-and-dispatch/) model. The runtime exposes stable C-compatible entrypoints to loaders; Rust-specific choices stay inside its crate boundary.
