---
title: Concurrency package - Decisions record (legacy index)
description: Migration index pointing to per-decision ADR files under adr/—normative
  text lives in ADRs, not this page.
template: splash
