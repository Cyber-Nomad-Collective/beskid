...
Pure Beskid primitive modules (`Core.Bytes`, `Core.Encoding`) live in `corelib_foundation`. They **must not** embed OS syscall semantics; binary I/O routes through [System.Syscall](/platform-spec/core-library/stability-and-api-shape/system-syscall/).
</SpecSection>
