...
| Mod host + diagnostics | `beskid_analysis::services`, `beskid_analysis::analysis` | **[Mod host bridge](/platform-spec/compiler/compiler-mods/mod-host-bridge/)**, **[Analysis, query, and diagnostics facades](/platform-spec/compiler/compiler-mods/analysis-query-diagnostics-facade/)** |
