...
- `compiler/crates/beskid_analysis/src/services/lower.rs` — authoritative `lower.type_check` pass.
- `compiler/crates/beskid_tests/src/analysis/type_check_diagnostics.rs` — prepare-spine type diagnostic conformance.
