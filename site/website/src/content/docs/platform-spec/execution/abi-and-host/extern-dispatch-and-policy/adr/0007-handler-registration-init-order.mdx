...
description: Corelib registers dispatch handlers before user static initialization in AOT and JIT.
specLevel: adr
status: Standard
...
relatedTopics:
  ...
  - type: Feature
    ...
    relation: Kernel vs dispatch registration
  - type: Feature
    ...
    relation: Runtime registration authority
---
