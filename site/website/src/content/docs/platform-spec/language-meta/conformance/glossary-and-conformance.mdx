...
| `ref T` | By-reference parameter or signature form; distinct from nullable or pointer types (see [Memory and references](/platform-spec/language-meta/memory-model/memory-and-references/)) |
