...
description: "Defines MUST / SHOULD / MAY usage across all Beskid specifications. Every diagnostic and platform RFC should reference this vocabulary consistently."
template: splash
...
The canonical chapter is **[Glossary and conformance](/platform-spec/language-meta/conformance/glossary-and-conformance/)** in the platform specification.
