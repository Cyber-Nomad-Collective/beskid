...
| **`TypeDefinition`** | Nominal record-like type with fields and conformances |
...
- `visibility`, `name`, `generics`, `conformances`, `fields`
- Per-field documentation via `field_docs`
