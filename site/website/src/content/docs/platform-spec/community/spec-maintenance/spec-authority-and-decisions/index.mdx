...
description: Normative rules for language law vs implementation domains, maturity
  (Proposed/Standard), and embedded decision records in feature hubs and articles.
template: splash
