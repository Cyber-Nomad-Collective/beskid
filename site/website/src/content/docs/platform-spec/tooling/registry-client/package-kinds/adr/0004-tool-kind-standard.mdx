...
description: Normative validator profile, CLI routing, and dashboard surface for packageKind tool.
specLevel: adr
status: Standard
adrId: D-TOOL-PCKG-0004
adrStatus: Accepted
adrDate: 2026-05-23
supersedes: D-TOOL-PCKG-0002
...
relatedTopics:
  ...
  - type: Feature
    ...
    relation: First non-CLI-bundled candidate for tool kind
---
