...
- The superrepo and compiler docs describe submodule layout for the canonical `beskid_corelib` tree; override sources in development with `BESKID_CORELIB_SOURCE` when needed.
