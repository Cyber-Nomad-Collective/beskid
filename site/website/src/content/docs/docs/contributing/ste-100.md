...
The tool keeps headings, list items, table rows, and prose paragraphs as separate blocks. It excludes frontmatter, fenced code, MDX tags and expression blocks, and requirement or scenario sections. Recursive review does not follow symbolic links.
