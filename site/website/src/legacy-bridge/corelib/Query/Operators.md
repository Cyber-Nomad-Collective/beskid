...
description: "QueryState carrier and composable operators (staged implementation)."
---
...
**Canonical document:** [`docs/Query/Operators.md`](https://github.com/Cyber-Nomad-Collective/beskid_compiler/blob/main/compiler/corelib/beskid_corelib/docs/Query/Operators.md)
