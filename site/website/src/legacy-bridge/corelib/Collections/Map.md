...
description: "Key/value map shape with logical entry count."
---
...
**Canonical document:** [`docs/Collections/Map.md`](https://github.com/Cyber-Nomad-Collective/beskid_compiler/blob/main/compiler/corelib/beskid_corelib/docs/Collections/Map.md)
