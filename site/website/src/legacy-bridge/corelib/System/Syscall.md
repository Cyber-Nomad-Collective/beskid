...
description: "Cross-platform syscall wrappers with typed descriptor/read-limit selectors and fd compatibility functions."
---
...
**Canonical document:** [`docs/System/Syscall.md`](https://github.com/Cyber-Nomad-Collective/beskid_compiler/blob/main/compiler/corelib/beskid_corelib/docs/System/Syscall.md)
