...
export const alreadyBetterSection: LandingTileSectionData = {
	...
	lead: 'Not everywhere—C# still wins on ecosystem size and library mass today. Where Beskid already ships code—not slideware—the compiler lowers to Cranelift object files, resolves host/DI graphs before launch, runs Mods with generation-checked syntax pipelines, schedules cooperative fibers over a syscall pool, and collects heap objects with a Go-style concurrent mark-and-sweep GC in the `abfall` runtime.',
	tiles: [
		...iocCompareTiles,
		{
			id: 'aot-first',
			...
			links: [
				{
					...
					href: 'https://learn.microsoft.com/en-us/dotnet/standard/garbage-collection/fundamentals',
					external: true,
				},
				{
		...
		},
		{
			...
			links: [
				...
				{
					label: 'C# async/await',
					href: 'https://learn.microsoft.com/en-us/dotnet/csharp/asynchronous-programming/',
					external: true,
				},
			],
			paragraphs: [
		...
		},
		{
			...
			links: [
				...
				},
				{
					...
					href: 'https://learn.microsoft.com/en-us/archive/msdn-magazine/2013/march/async-await-best-practices-in-asynchronous-programming',
					external: true,
				},
			],
			paragraphs: [
		...
		},
		{
			...
			specHref: '/platform-spec/language-meta/composition/dependency-injection/design-model/',
			links: [
				{
					label: 'Dependency injection guidelines',
					href: 'https://learn.microsoft.com/en-us/dotnet/core/extensions/dependency-injection/guidelines',
					external: true,
				},
			],
			paragraphs: [
		...
		},
		{
			...
			specHref: '/platform-spec/compiler/compiler-mods/incremental-scheduling-determinism/',
			links: [
				{
