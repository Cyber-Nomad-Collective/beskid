...
export const dotnetRightBullets: DotNetBullet[] = [
	{
		...
		sources: [
			{ label: 'Language-Integrated Query (LINQ)', href: 'https://learn.microsoft.com/en-us/dotnet/csharp/linq/' },
			{ label: 'Asynchronous programming (async/await)', href: 'https://learn.microsoft.com/en-us/dotnet/csharp/asynchronous-programming/' },
			{ label: 'Records', href: 'https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/record' },
			{ label: 'Pattern matching', href: 'https://learn.microsoft.com/en-us/dotnet/csharp/fundamentals/functional/pattern-matching' },
		],
	},
	{
		...
		sources: [
			{ label: 'C# programming guide', href: 'https://learn.microsoft.com/en-us/dotnet/csharp/tour-of-csharp/' },
			{ label: 'Nullable reference types', href: 'https://learn.microsoft.com/en-us/dotnet/csharp/nullable-references' },
		],
	},
	{
		...
		sources: [
			{ label: '.NET CLI overview', href: 'https://learn.microsoft.com/en-us/dotnet/core/tools/' },
			{ label: 'NuGet documentation', href: 'https://learn.microsoft.com/en-us/nuget/' },
			{ label: 'Debug with Visual Studio Code', href: 'https://learn.microsoft.com/en-us/dotnet/core/tutorials/debugging-with-visual-studio-code' },
		],
	},
];
...
export const dotnetWrongBullets: DotNetBullet[] = [
	{
		text: 'Reflection-heavy libraries fight Native AOT instead of compiling cleanly.',
		example:
		...
		sources: [
			{
				...
				href: 'https://learn.microsoft.com/en-us/dotnet/core/deploying/native-aot/fixing-warnings',
			},
			{
				label: 'Creating AOT-compatible libraries (.NET Blog)',
				href: 'https://devblogs.microsoft.com/dotnet/creating-aot-compatible-libraries/',
			},
			{
				label: 'Reflection in Native AOT mode (dotnet/runtime)',
				href: 'https://github.com/dotnet/runtime/blob/main/src/coreclr/nativeaot/docs/reflection-in-aot-mode.md',
			},
		],
	},
	{
		...
		sources: [
			{
				label: 'System.Text.Json incremental generator performance (dotnet/runtime#68353)',
		...
		sources: [
			{
				...
				href: 'https://learn.microsoft.com/en-us/aspnet/core/fundamentals/native-aot',
			},
			{
	...
	{
		text: 'Platform features live in Microsoft.Extensions.* layers, not language semantics.',
		example:
		...
		sources: [
			...
			},
			{
				...
				href: 'https://learn.microsoft.com/en-us/dotnet/core/extensions/dependency-injection/usage',
			},
			{
				label: 'Generic host configuration',
				href: 'https://learn.microsoft.com/en-us/dotnet/core/extensions/generic-host',
			},
		],
	},
	{
		text: 'CIL and VM indirection remain the default tax on performance-sensitive work.',
		example:
		...
		sources: [
			{
				...
				href: 'https://learn.microsoft.com/en-us/dotnet/standard/managed-execution-process',
			},
			{
			...
			},
			{
				...
				href: 'https://learn.microsoft.com/en-us/dotnet/core/runtime-config/compilation',
			},
		],
	},
];
