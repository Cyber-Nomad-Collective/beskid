...
import { t as Route$15 } from "./admin-DH-Sf87g.mjs";
...
import { C as writeAuthConfig, S as verifySetupToken, _ as isOnboarded, a as clearSessionCookieHeader, b as resolveOAuthConfig, c as env, d as getPairedApp, f as getServiceTokenForApp, g as isOAuthConfigured, h as isAdminLogin, i as approvePairing, n as AUTH_HUB_ISSUER, o as createPairingRequest, p as getSessionFromRequest, u as getGithubTokenForSession, v as listEnabledApps } from "./pairing-C4aEAPts.mjs";
import { n as handleCallbackGet, t as Route$16 } from "./login-DFTvklNb.mjs";
import { t as Route$17 } from "./onboarding-C6tbS9Pc.mjs";
import { t as Route$18 } from "./pairing-Csouh3jZ.mjs";
import { t as Route$19 } from "./profile-CpHInzxx.mjs";
import { t as Route$20 } from "./routes-D83SRqm-.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DZrUQi2W.js
...
var styles_default = "/assets/styles-IehAM4Xz.css";
...
var Route$13 = createFileRoute("/callback")({
	server: { handlers: { GET: ({ request }) => handleCallbackGet(request) } },
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var Route$12 = createFileRoute("/account")({ beforeLoad: () => {
	throw redirect({ to: "/profile" });
} });
var Route$11 = createFileRoute("/api/v1/me")({ server: { handlers: { GET: async ({ request }) => {
...
var Route$10 = createFileRoute("/api/v1/health")({ server: { handlers: { GET: async () => Response.json({
	ok: true,
	version: "v1"
}) } } });
var Route$9 = createFileRoute("/api/v1/apps")({ server: { handlers: { GET: async () => {
	const apps = await listEnabledApps();
	return Response.json({ apps });
} } } });
var Route$8 = createFileRoute("/api/auth/logout")({ server: { handlers: {
	POST: async () => {
...
var $$splitComponentImporter = () => import("./new-Dy1ae_UO.mjs");
var Route$7 = createFileRoute("/admin/pairing/new")({
	loader: async () => {
...
var Route$6 = createFileRoute("/api/v1/pairing/status")({ server: { handlers: { GET: async ({ request }) => {
...
var Route$5 = createFileRoute("/api/v1/pairing/requests")({ server: { handlers: { POST: async ({ request }) => {
...
var Route$4 = createFileRoute("/api/v1/pairing/approve")({ server: { handlers: { POST: async ({ request }) => {
	let json;
	try {
		json = await request.json();
	} catch {
...
var Route$3 = createFileRoute("/api/v1/openapi/json")({ server: { handlers: { GET: async () => Response.json(openApiV1Document) } } });
...
var Route$2 = createFileRoute("/api/v1/github/$")({ server: { handlers: {
...
var Route$1 = createFileRoute("/api/v1/admin/status")({ server: { handlers: { GET: async () => {
...
var setupSchema = object({
	...
	adminGitHubLogins: array(string().min(1)).min(1),
	apps: array(object({
		id: _enum([
			"tracker",
			"nexus",
...
var Route = createFileRoute("/api/v1/admin/setup")({ server: { handlers: { POST: async ({ request }) => {
	...
	await writeAuthConfig({
		...
		adminGitHubLogins: parsed.data.adminGitHubLogins.map((s) => s.trim().toLowerCase()),
		apps: []
	});
...
var CallbackRoute = Route$13.update({
	id: "/callback",
	path: "/callback",
	getParentRoute: () => Route$14
});
...
var AdminPairingIndexRoute = Route$18.update({
	id: "/admin/pairing/",
	path: "/admin/pairing/",
	getParentRoute: () => Route$14
});
var ApiV1MeRoute = Route$11.update({
	id: "/api/v1/me",
	path: "/api/v1/me",
	getParentRoute: () => Route$14
});
var ApiV1HealthRoute = Route$10.update({
	id: "/api/v1/health",
	path: "/api/v1/health",
	getParentRoute: () => Route$14
});
var ApiV1AppsRoute = Route$9.update({
	id: "/api/v1/apps",
	path: "/api/v1/apps",
	getParentRoute: () => Route$14
});
...
var AdminPairingNewRoute = Route$7.update({
	id: "/admin/pairing/new",
	path: "/admin/pairing/new",
	getParentRoute: () => Route$14
});
var ApiV1PairingStatusRoute = Route$6.update({
	id: "/api/v1/pairing/status",
	path: "/api/v1/pairing/status",
	getParentRoute: () => Route$14
});
var ApiV1PairingRequestsRoute = Route$5.update({
	id: "/api/v1/pairing/requests",
	path: "/api/v1/pairing/requests",
	getParentRoute: () => Route$14
});
var ApiV1PairingApproveRoute = Route$4.update({
	id: "/api/v1/pairing/approve",
	path: "/api/v1/pairing/approve",
	getParentRoute: () => Route$14
});
var ApiV1OpenapiJsonRoute = Route$3.update({
	id: "/api/v1/openapi/json",
	path: "/api/v1/openapi/json",
	getParentRoute: () => Route$14
});
var ApiV1GithubSplatRoute = Route$2.update({
	id: "/api/v1/github/$",
	path: "/api/v1/github/$",
	getParentRoute: () => Route$14
});
var ApiV1AdminStatusRoute = Route$1.update({
...
var rootRouteChildren = {
	...
	ApiV1AdminSetupRoute: Route.update({
