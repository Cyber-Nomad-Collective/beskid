...
//#region node_modules/.nitro/vite/services/ssr/assets/pairing-C4aEAPts.js
...
async function writeAuthConfig(config) {
	...
	setHubSetting("admin_github_logins", JSON.stringify(config.adminGitHubLogins));
}
...
//#endregion
export { writeAuthConfig as C, verifySetupToken as S, isOnboarded as _, clearSessionCookieHeader as a, resolveOAuthConfig as b, env as c, getPairedApp as d, getServiceTokenForApp as f, isOAuthConfigured as g, isAdminLogin as h, approvePairing as i, getAppById as l, hubBrowserSessionCookieHeader as m, AUTH_HUB_ISSUER as n, createPairingRequest as o, getSessionFromRequest as p, HUB_USER_TOKEN_TTL_SECONDS as r, createUserSession as s, AUTH_APP_META as t, getGithubTokenForSession as u, listEnabledApps as v, sealHubBrowserSession as x, listPairingRequests as y };
