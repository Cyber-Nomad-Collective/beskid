...
var require_react_dom_server_bun_production = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	if ("19.2.6" !== isomorphicReactPackageVersion$jscomp$inline_821) throw Error("Incompatible React versions: The \"react\" and \"react-dom\" packages must have the exact same version. Instead got:\n  - react:      " + (isomorphicReactPackageVersion$jscomp$inline_821 + "\n  - react-dom:  19.2.6\nLearn more: https://react.dev/warnings/version-mismatch"));
