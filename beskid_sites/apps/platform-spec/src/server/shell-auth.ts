...
/**
 * Shell auth helpers for the platform-spec app.
 *
...
export const shellAuth = createShellAuth({
	...
	clientId: env.PLATFORM_SPEC_OIDC_CLIENT_ID ?? "",
	clientSecret: env.PLATFORM_SPEC_OIDC_CLIENT_SECRET ?? "",
	sessionSecret: env.SESSION_SECRET ?? "",
	sessionCookieName: "beskid_platform_spec_session",
