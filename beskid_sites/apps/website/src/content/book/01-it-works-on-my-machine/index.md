...
Start with [Downloads and rolling releases](/book/01-it-works-on-my-machine/downloads-and-releases/), or jump straight to [First smoke test](/book/01-it-works-on-my-machine/first-smoke-test/) if someone already installed the CLI for you.
