...
- [Package client CLI](/book/18-packages-without-npm-trauma/pckg-cli/) — tutorial walkthrough of `beskid pckg` (the real command; there is no `beskid pkg`).
...
beskid build --project path/to/MyApp.bproj
```
