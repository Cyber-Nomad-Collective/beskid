...
- Conventions enforced by **social pressure** rather than fancy types—which is both a feature and a trap (see [1.7 segfault or not to segfault](/book/00-why-beskid-exists/segfault-or-stop-the-world/) and [1.9 Conclusion](/book/00-why-beskid-exists/conclusion/)).
