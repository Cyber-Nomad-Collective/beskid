...
/**
 * Shell auth helpers for the website app.
 *
...
export const shellAuth = createShellAuth({
	...
	clientId: env.WEBSITE_OIDC_CLIENT_ID ?? "",
	clientSecret: env.WEBSITE_OIDC_CLIENT_SECRET ?? "",
	sessionSecret: env.SESSION_SECRET ?? "",
	sessionCookieName: "beskid_website_session",
