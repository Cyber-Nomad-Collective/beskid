...
import type { PackageSummary, PublisherSummary } from "#/lib/pckg-api";
...
const profile: PublisherSummary = {
	subject: "github:42",
	displayName: "Octocat",
...
describe("PublisherProfile", () => {
	it("renders the hero and published packages", () => {
		...
		expect(screen.getByText("Verified Beskid publisher.")).toBeInTheDocument();
