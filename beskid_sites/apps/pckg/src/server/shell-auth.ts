...
/**
 * Shell auth helpers for the pckg app.
 *
...
export const shellAuth = createShellAuth({
	...
	clientId: env.PCKG_OIDC_CLIENT_ID ?? "",
	clientSecret: env.PCKG_OIDC_CLIENT_SECRET ?? "",
	sessionSecret: env.SESSION_SECRET ?? "",
	sessionCookieName: "beskid_pckg_session",
	oidcStateCookieName: "beskid_pckg_oidc_state",
