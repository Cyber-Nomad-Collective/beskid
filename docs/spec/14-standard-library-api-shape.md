...
- Canonical language-level `Result` semantics live in `docs/spec/07-error-handling.md`.
...
- Language-level `Extern` syntax and typing are defined in `docs/spec/18-ffi-and-extern.md`.
...
- Lambda/closure language semantics: `docs/spec/17-lambdas-and-closures.md`.
- `for in` language semantics: `docs/spec/05-control-flow.md`.
