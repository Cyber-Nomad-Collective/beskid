...
- Language grammar/syntax terms: `docs/spec/01-lexical-and-syntax.md`.
- Type-system terms: `docs/spec/02-types.md`.
- Lambda/closure semantics: `docs/spec/17-lambdas-and-closures.md`.
- Event semantics: `docs/spec/16-events.md`.
- FFI/Extern language contract: `docs/spec/18-ffi-and-extern.md`.
