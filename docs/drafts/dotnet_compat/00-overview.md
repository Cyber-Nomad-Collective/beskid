...
| `01-type-mapping.md` | Primitive types, structs, enums, generics |
| `02-construct-mapping.md` | Statements, expressions, control flow |
| `03-class-flattening.md` | Class hierarchy elimination strategy |
| `04-bcl-facade.md` | BCL type mapping to Beskid stdlib |
| `05-unsupported.md` | Explicitly unsupported C# features and error strategy |
| `06-tooling.md` | CLI integration, project model, incremental workflow |
